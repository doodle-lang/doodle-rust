...
/// A float literal that rounds to ±∞ is a **static error** (L§3.6.2, S-56), keeping the
/// finite-float invariant true at the source boundary; underflow to 0.0 stays legal.
#[test]
